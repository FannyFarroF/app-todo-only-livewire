    ...
    <div class="bg-slate-100 flex  flex-wrap justify-between p-3 rounded-lg  mb-3">
        <div class="me-2 w-full lg:w-7/12">
            <form>
                ...
                <x-text-input wire:model.live="search" id="search" class="block mt-1 w-full" type="text" autofocus placeholder="Search by title"/>
            </form>
        </div>
    ...
    <table class="w-full border-collapse border border-slate-300 mb-10 text-left">
        <thead class="bg-slate-200 text-center">
            <tr>
                ...
                <th class="border border-slate-300 p-3">Created</th>
